 ...
 */
public class LedgerAddress implements Comparable<LedgerAddress> {
    //region Members
    ...
    public String toString() {
        return String.format("{LedgerId = %d, LedgerSequence = %d, EntryId = %d}",
                this.ledgerId, getLedgerSequence(), getEntryId());
    }
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof LedgerAddress && this.compareTo((LedgerAddress) obj) == 0;
    }
